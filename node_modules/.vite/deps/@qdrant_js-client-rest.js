...
// node_modules/.pnpm/@qdrant+js-client-rest@1.15.0_typescript@5.8.3/node_modules/@qdrant/js-client-rest/dist/browser/index.js
var none = {
  isNone: function() {
    return true;
  },
...
function mergeRequestInit(first, second) {
  const headers = new Headers(first == null ? void 0 : first.headers);
  const other = new Headers(second == null ? void 0 : second.headers);
...
function getFetchParams(request) {
  ...
  const headers = sendBody(request.method) ? getHeaders(body, (_a = request.init) == null ? void 0 : _a.headers) : new Headers((_b = request.init) == null ? void 0 : _b.headers);
  ...
  use.push(async (url, init, next) => {
    ...
    try {
      ...
      if (error instanceof ApiError && error.status === 429) {
        const retryAfterHeader = (_a = error.headers.get("retry-after")) == null ? void 0 : _a[0];
        if (retryAfterHeader) {
...
//# sourceMappingURL=@qdrant_js-client-rest.js.map
